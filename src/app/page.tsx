...
export default function LandingPage() {
  ...
  <div id="home" data-section="home">
      ...
      mediaItems={[
        {
          imageSrc: "http://img.b2bpic.net/free-photo/closeup-purple-nail-polish-against-white_181624-44649.jpg",
          imageAlt: "Luxury Beauty Promo 1",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/dreamy-aesthetic-cosmetic-product-with-fresh-background_23-2151382903.jpg",
          imageAlt: "Luxury Beauty Promo 2",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/serum-bottle-green-leaf-arrangement_23-2149353092.jpg",
          imageAlt: "Serum bottle and green leaf arrangement",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/high-angle-cosmetics-arrangement_23-2149270018.jpg",
          imageAlt: "High angle cosmetics arrangement",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/make-up-concept-with-pink-lipstick_23-2149030371.jpg",
          imageAlt: "Make up concept with pink lipstick",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, we guarantee 100% authenticity from official brand suppliers.",
        },
        {
          id: "f2",
          title: "How long is shipping?",
          content: "Orders are typically processed within 24 hours and delivered within 3-5 days.",
        },
        {
          id: "f3",
          title: "Can I return items?",
          content: "Yes, we accept returns on unopened items within 14 days of purchase.",
        },
        {
          id: "f4",
          title: "Do you offer gifts?",
          content: "Yes, we offer premium luxury gift wrapping for all orders.",
        },
        {
          id: "f5",
